...
class WorldModel(nn.Module):
    ...
    def forward(self, 
        ...
        # Project input embeddings (current state) to GPT-2 hidden dimension
        ...
        # Prepare the binary action labels as conditioning input in our world model
        # TODO: Implement action embedding with current state embedding
