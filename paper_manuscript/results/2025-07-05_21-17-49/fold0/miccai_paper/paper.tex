...
\keywords{Surgical Action Planning \and Imitation Learning \and Reinforcement Learning \and Temporal Planning \and Medical AI}
\end{abstract}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{triplet_component_planning_horizon.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{qualitative_combined_examples.eps}
...
% Nwoye, C.I., et al.: CholecT50: An endoscopic image dataset for surgical action triplet recognition. Medical Image Analysis \textbf{77}, 102337 (2022)
% 
