...
class RLExperimentRunner:
    """
    Main class to run RL experiments and compare with imitation learning
    """
    ...
    def run_baseline_imitation_learning(self, train_data: List[Dict], val_data: List[Dict]):
        """
        Run baseline imitation learning using your existing world model
        """
        self.logger.info("=== Running Baseline Imitation Learning ===")
        
        # Your world model is already trained with imitation learning
        # We'll evaluate its performance directly
